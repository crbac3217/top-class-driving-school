export default {
  ...
  testimonials: {
    ...
    items: [
      {
        name: 'Kevin L.',
        text: '第一次就考到5号牌！教练用广东话解释得非常清楚，十分耐心。',
      },
      {
        name: 'Amy T.',
        text: '上门接送真的很方便，完全不用担心去驾校的麻烦。非常专业！',
      },
      {
        name: 'Jason W.',
        text: '7号牌课程很好，教练指出了很多考官常见的扣分点。强烈推荐！',
      },
    ],
  },
  contact: {
    title: '预约课程',
    subtitle: '致电或 WhatsApp 查询收费及空档。',
    callSms: '致电 & 短信',
    whatsapp: 'WhatsApp',
    call: '致电',
    phone: '+17788916091',
  ...
  footer: {
    tagline: 'ICBC持牌5号/7号牌教练，英文、广东话及普通话授课。',
    rights: '版权所有。',
  },
};
